$(document).ready(function() {
    ...
    var selectors = ['div#appbundle_animal_animalStates', 'div#appbundle_animal_images'];
    // Select the label of precedent selectors
    var labelForms = ['div#appbundle_animal_animalStates div:first-child label', 'div#appbundle_animal_images div:first-child label' ]
    // Select the adding form links corresponding
    var buttons = ['#add_state', '#add_image'];
